    ...
    <>
      { start === false ? (
        <main className="h-auto w-auto flex-col justify-center">
          ...
          <button
            className="block mx-auto text-white text-xl bg-orange-700 px-8 py-5 mb-３ rounded-full shadow-md shadow-orange-950 active:shadow-none active:translate-y-1 "
